...
**Scope:** v1.0 (Release-Readiness) + v1.1 (Quality & Operational Excellence)
...
**Source:** v1.1 operational · **Effort:** ~30 min
...
**Source:** v1.0 operational · **Effort:** ~2h
...
**Source:** v1.1 (Phase 6 deferred) · **Effort:** ~1h
...
**Source:** v1.0 tech debt · **Effort:** ~30 min
...
**Source:** v1.0 tech debt · **Effort:** ~2h (exploratory)
...
**Source:** v1.1 operational gap · **Effort:** ~1h
...
**Source:** v1.1 (Phase 7) · **Effort:** ~30 min
...
**Source:** v1.1 (Phase 8) · **Effort:** ~30 min
...
**Source:** v1.0 retrospective · **Effort:** ~2h
...
**Source:** v1.0 architecture · **Effort:** ongoing
...
**Source:** v1.1 (Phase 7) · **Effort:** low
...
**Goal:** Audit and translate all inline (`#`) comments in Python source files to English. Docstrings were covered in v1.1 Phase 8, but inline comments may still have Portuguese.
...
**Goal:** Sync `docs/` with all v1.1 changes (already partially done in Phase 8), update `README.pt-BR.md`, add `README.es.md`.
...
**Notes:** v1.1 Phase 8 added OTCS product auto-tagging (10 products) — this is a superset that adds Vendor, Subsystem, Version dimensions.
...
| Item | Source | Status |
|------|--------|--------|
| Rich markup `[/{variable}]` → `[/]` bugs | v1.0 | Fixed in v1.0 Phase 1 |
| Missing `f`-string prefixes in CLI | v1.0 | Fixed in v1.0 Phase 3 |
| 19 pre-existing test failures | v1.0 | 18 fixed; 1 removed assertion (see S-03) |
| `test_smoke.py` module-level starlette stubs | v1.1 | Mitigated — SSE tests run in separate process (see N-03) |
| `server/` legacy package references in docs | v1.1 | Fixed in v1.1 Phase 8 docs refresh |
| Portuguese docstrings | v1.1 | All translated to English in v1.1 Phase 8 |
| Missing English docstrings on public APIs | v1.1 | All filled in v1.1 Phase 8 |
