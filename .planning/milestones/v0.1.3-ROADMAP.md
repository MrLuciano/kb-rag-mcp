# v0.1.3 Milestone Archive — Post-Ship Polish & Infrastructure
...
**Goal:** Sync the `docs/` folder with all changes shipped since v0.1.0, update README.md and README.pt-BR.md to reflect current state, and add a new README.es.md in Spanish.
